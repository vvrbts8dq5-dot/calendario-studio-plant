...
function vaiAllaPagina(pagina) {
  ...
  document.getElementById('topbar-title').textContent = TITOLI_PAGINA[pagina] || '';
}
...
// più spazio orizzontale allo schermo diviso; la freccia in alto a
// sinistra la fa ricomparire in qualsiasi momento senza uscire dal
// progetto. Se in quel momento è aperto lo schermo diviso, ricalcoliamo
// anche l'altezza (il layout può spostarsi leggermente quando la sidebar
// appare/scompare).
